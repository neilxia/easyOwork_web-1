//列表
function smslistCtrl(){
    return['$rootScope','$scope','$filter','$modal','assetService','MsgService','LocalStorage','Common','$state',function($rootScope,$scope,$filter,$modal,assetService,MsgService,LocalStorage,Common,$state){

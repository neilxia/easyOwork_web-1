 ...
 */
var app =angular.module('wechat.servicesRest',[]);
...
function companyService(){
    return ['$http','AppConfig',function($http,AppConfig){
        return {
            ...
            //POST  B0003-查询公司组织架构
            inquiryWechatCompanyOrg:function(form){
                return $http.post(AppConfig.BASE_URL+'work/rest/inquiryWechatCompanyOrg',form)
            },
            //POST 	B0004-修改公司部门

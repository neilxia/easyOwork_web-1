            ...
            return function(overwrites) {
                return {
                    ...
                    link: function(scope, elem, attrs, ctrl) {
                        ...
                        // By default consider single element without any linked form.脽
                        var hasForm = false;
...
angular.module('xeditable').factory('editableIcons', function() {
    ...
    var icons = {
        ...
        default: {
            ...
            'bs3': {
                ok: 'iconfont icon-fuxuankuang f10',
                cancel: 'iconfont icon-close f10',
                clear: 'glyphicon glyphicon-trash f10'
            }
        },
        external: {
            'font-awesome': {
...
angular.module('xeditable').factory('editableThemes', function() {
    var themes = {
        ...
        'bs3': {
            ...
            errorTpl:    '<div class="editable-error help-block" data-ng-if="$error" data-ng-bind="$error"></div>',
            buttonsTpl:  '<span class="editable-buttons"></span>',
            submitTpl:   '<button type="submit" class="btn btn-primary btn-xs">确定</button>',
            //submitTpl:   '<button type="submit" class="btn btn-primary btn-xs"><span></span></button>',
            cancelTpl:   ''+
            //cancelTpl:   '<button type="button" class="btn btn-default btn-xs" ng-click="$form.$cancel()">'+
            '<span></span>'+
            '</button>',
            resetTpl:    '<button type="reset" class="btn btn-danger bnt-xs">clear</button>',
